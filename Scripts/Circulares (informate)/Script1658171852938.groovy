...
WebUI.setText(findTestObject('Object Repository/Circulares/input_nombreusuario'), 'biaani.da')

WebUI.setEncryptedText(findTestObject('Object Repository/Circulares/input_pass'), 'aCNOeMVT6E+hS+e2Ost8OQ==')
