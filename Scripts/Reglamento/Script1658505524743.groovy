...
WebUI.click(findTestObject('Object Repository/Reglamento/a_Reglamento'))

WebUI.rightClick(findTestObject('Object Repository/Reglamento/p_El presente reglamento seala los lineamie_8d3604'))
