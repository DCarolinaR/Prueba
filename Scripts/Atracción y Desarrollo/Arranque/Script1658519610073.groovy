...
WebUI.navigateToUrl('https://pru-gnp-portalideas.biaani.com/index.php/atraccion-y-desarrollo/arranque')

WebUI.verifyElementText(findTestObject('Objetos/pub_ideas'), 'Arranque')
