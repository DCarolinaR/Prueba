...
WebUI.click(findTestObject('Object Repository/Tips de Ventas/a_Tips de Venta'))

WebUI.rightClick(findTestObject('Object Repository/Tips de Ventas/div_Tips de Venta'))
